...
public class ProbE {
    ...
    long findMST(Edge[] edges, int n, int root) {
        ...
        minEdge[root] = 0;
//        out.println("r" + Integer.toString(root));
//        out.println(edges.length);
        for (int v = 0; v < n; ++v) {
            if (v != root) {
                ...
                res += minEdge[v];
//                out.println(Integer.toString(v) + " " + Long.toString(minEdge[v]));
            }
        }
...
//                out.println(Long.toString(e.w - minEdge[e.v]) + " " + Long.toString(comp[e.u]) + " " + Long.toString(comp[e.v])); 
            }
        }
//
//        out.println(res);
